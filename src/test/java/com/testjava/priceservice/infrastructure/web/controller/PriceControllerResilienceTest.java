...
class PriceControllerResilienceTest {
  ...
  @Mock private FindPriceUseCasePort findPriceUseCase;

  @Mock private PriceResponseMapper responseMapper;

  @InjectMocks private PriceController priceController;

  @Test
  void whenUseCaseThrowsExceptionThenFallbackIsTriggered() {
    // Arrange
    ...
    ResponseEntity<?> response =
        priceController.fallbackGetPrice(now, productId, brandId, exception);
