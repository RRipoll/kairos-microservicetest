...
class InvalidPriceQueryExceptionTest {
  ...
  void shouldCreateExceptionWithAllParameters() {
    ...
    // When
    InvalidPriceQueryException exception =
        new InvalidPriceQueryException(field, TEST_PRODUCT_ID, reason);
  ...
  void shouldCreateExceptionWithCause() {
    ...
    // When
    InvalidPriceQueryException exception =
        new InvalidPriceQueryException(field, TEST_BRAND_ID, reason, cause);
  ...
  void shouldHandleNullFieldGracefully() {
    // When
    InvalidPriceQueryException exception =
        new InvalidPriceQueryException(null, TEST_PRODUCT_ID, "Some reason");
  ...
  void shouldHandleNullValueGracefully() {
    // When
    InvalidPriceQueryException exception =
        new InvalidPriceQueryException("testField", null, "Some reason");
  ...
  void shouldHandleNullReasonGracefully() {
    // When
    InvalidPriceQueryException exception =
        new InvalidPriceQueryException("testField", TEST_PRODUCT_ID, null);
  ...
  void shouldInheritFromPriceServiceException() {
    // When
    InvalidPriceQueryException exception =
        new InvalidPriceQueryException("field", "value", "reason");
  ...
  void shouldHandleDifferentValueTypes() {
    // When
    InvalidPriceQueryException stringException =
        new InvalidPriceQueryException("stringField", "stringValue", "reason");
    InvalidPriceQueryException numberException =
        new InvalidPriceQueryException("numberField", 123, "reason");
