  ...
  public OpenAPI openAPI() {
    ...
    Info info =
        new Info()
            ...
            .contact(contact)
            .description(
                "REST API for e-commerce price consultation with hexagonal architecture and DDD principles")
            .license(license)
            .summary(
                "Price consultation service that manages product pricing with time-based validity and priority rules");
