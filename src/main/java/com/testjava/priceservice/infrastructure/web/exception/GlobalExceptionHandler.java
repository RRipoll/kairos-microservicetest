...
/**
 * Global exception handler responsible for converting domain exceptions to appropriate HTTP
 * responses. This class has the single responsibility of handling exception-to-HTTP-response
...
public class GlobalExceptionHandler {
  ...
  /** Handles price not found exceptions. Maps to HTTP 404 Not Found. */
  ...
  /** Handles invalid price query exceptions. Maps to HTTP 400 Bad Request. */
  @ExceptionHandler(InvalidPriceQueryException.class)
  public ResponseEntity<ErrorResponse> handleInvalidPriceQueryException(
      InvalidPriceQueryException ex) {
  ...
  /** Handles illegal argument exceptions (validation errors). Maps to HTTP 400 Bad Request. */
  ...
  /** Handles general price service exceptions. Maps to HTTP 422 Unprocessable Entity. */
  ...
  /** Handles missing request parameters. Maps to HTTP 400 Bad Request. */
  ...
  /** Handles method argument type conversion errors. Maps to HTTP 400 Bad Request. */
  @ExceptionHandler(
  ...
  /** Handles unexpected exceptions. Maps to HTTP 500 Internal Server Error. */
