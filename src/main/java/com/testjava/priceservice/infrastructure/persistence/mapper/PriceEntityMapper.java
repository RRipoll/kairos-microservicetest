...
/**
 * Mapper responsible for converting between persistence entities and domain objects. This class has
 * the single responsibility of handling the transformation between infrastructure and domain layer
 * data structures.
 */
@Component
