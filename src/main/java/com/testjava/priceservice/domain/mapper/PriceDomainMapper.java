...
/**
 * Mapper responsible for transformations within the domain layer. This class has the single
 * responsibility of converting between different domain objects while maintaining domain integrity.
 */
@Component
public class PriceDomainMapper {

  /**
   * Maps a domain Price entity to a PriceResult. This transformation represents the result of a
