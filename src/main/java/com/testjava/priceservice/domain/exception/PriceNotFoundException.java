...
/**
 * Exception thrown when no applicable price is found for the given criteria. This exception
...
public class PriceNotFoundException extends PriceServiceException {
  ...
  public PriceNotFoundException(
    ...
    super(
        String.format(
            ValidationMessages.PRICE_NOT_FOUND_FORMAT, productId, brandId, applicationDate));
